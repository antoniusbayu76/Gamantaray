...
try:
    ser1 = serial.Serial(port, bautRate, timeout=None)
    ser2 = txfer.SerialTransfer(port, bautRate, timeout=None)
    arduino = 'ada'
    #startNyelem = 1000
except:
    arduino = 'gada'
...
while True:
   ...
   # cv2.putText(img, '+', (img.shape[1]//2 ,100), cv2.FONT_HERSHEY_TRIPLEX, 0.6, (0,0,0), thickness=1)
    ...
    if cx > batasLurus['-'] and cx < batasLurus['+']:
        ...
        # ser2.send(90)
            ...
            ##Belok kiri tipis
    if cx > batasBelokTipis["-kiri"] and cx < batasBelokTipis["-kanan"]:
        if sudut1 < 130 :
            print(sudut1)
            sudut1 += 2
        elif sudut1 == 130 :
    ...
    if cx > batasBelokTipis["+kiri"] and cx < batasBelokTipis["+kanan"]:
        ...
        sudut2 = 90
            ...
            ##Belok kiri besar
    if cx > batasBelokBesar['-kiri'] and cx < batasBelokBesar['-kanan']:
        if sudut3 < 150 :
            print(sudut1)
            sudut3 += 2
        elif sudut3 == 150 :
