...
listLowRed = [np.array([163,43,142]),np.array([0, 78, 67])] # [np.array([0, 111, 109])]
listUpRed = [np.array([180,255,255]),np.array([6, 255, 177])] #[np.array([3, 190, 178])] 
nRed = 0

listLowGreen = [np.array([76, 121, 17 ]), np.array([62,147,0])] #[np.array([83, 28, 101])] 
listUpGreen = [np.array([97, 255, 255]),np.array([179, 255, 255])] #[np.array([94, 116, 158])] 
nGreen = 0
...
while True:
    ...
    cv2.line(img, (img.shape[1]//5,blockAtas-50), (-5,blockAtas+10), (0,0,0), thickness=blockKiri) ###
    cv2.line(img, (img.shape[1]-img.shape[1]//5,blockAtas-50), (img.shape[1]+5,blockAtas+10), (0,0,0), thickness=blockKanan) ###
   #------------------------------------------------------------------------------------------------------------ 
   #roi tambahan
    ...
    cv2.fillPoly(img, pts=[points], color=(0, 0, 0))#merah
    ...
    cv2.fillPoly(img, pts=[points2], color=(0, 0, 0))#hijau
